...
<li class="todo <?= $todo["status"] == "done"?"done":"" ?>">
	...
	<div class="edit-todo">
		<textarea 
			...
			name="body" 
			form="edit-todo-<?= $todo["id"] ?>"><?= $todo["body"] ?></textarea>
		<button class="save" value="<?= $todo["id"] ?>">Save</button>
		<button class="cancel">Cancel</button>
	</div>
	<div class="todo-actions">
		<a href="/todo/<?= $todo["id"] ?>">link</a>
		<button class="edit-button">Edit</button>
		<form class="done-form" action="/put/todo" autocomplete="off" method="post" id="edit-todo-<?= $todo["id"] ?>">
